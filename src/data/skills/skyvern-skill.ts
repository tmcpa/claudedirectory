...
export const skyvernSkill: Skill = {
  slug: "skyvern-skill",
  ...
  tags: ["browser", "automation", "scraping", "ai", "workflows"],
  featured: false,
  ...
  content: `# Skyvern Browser Automation -- CLI Judgment Procedure
...
| \`references/cli-parity.md\` | CLI/MCP mapping and agent-aware features |`,
  relatedItems: [
    { type: "mcp-server", slug: "skyvern", relationship: "works-with" },
  ],
};
