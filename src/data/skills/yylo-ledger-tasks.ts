...
export const yyloLedgerTasksSkill: Skill = {
  slug: "yylo-ledger-tasks",
  title: "YYLO Ledger Tasks",
  description:
    "Run a Kanban board for coding agents from the terminal: create, search, update, and dependency-order tasks with receipts via the YYLO Ledger CLI",
  tags: ["project-management", "kanban", "tasks", "workflow", "coding-agents"],
  featured: false,
  ...
  repoUrl: "https://github.com/yylo-dev/yylo-skills",
  content: `# YYLO Ledger Tasks

Run a Kanban board for coding agents from the terminal. This skill teaches Claude Code (and other coding agents) to operate YYLO Ledger task management: creating, searching, and updating tasks, managing dependencies, and planning safe parallel execution with receipts. Maintained by the YYLO team; works with standalone YYLO Ledger or full YYLO orchestration.
...
https://github.com/yylo-dev/yylo-skills (MIT)
`,
};
